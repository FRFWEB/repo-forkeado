...
const getLinkIndex = () => {
    const linkActive =
        document.querySelector(".link-active") ||
...
//:class="{ close: isSidebarClosed, hoverable: isSidebarHoverable }
</script>
                ...
                <div class="menu_items">
                    <ul class="menu_item">
                        <li
                            ...
                            :class="{
                                'first-active':
                                    index == 0 && isActive(item.routeName),
                            }"
                        >
                            <template
                            ...
                            <template v-else>
                                <Link
                                    ...
                                    :class="{
                                        'menu-active': isActive(item.routeName),
                                    }"
                                    :item-link-index="index"
