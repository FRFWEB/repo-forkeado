...
const getModalStatus = ref(props.modalActive);
//OPEN AND CLOSE MODAL BY CREATE NEW ITEM
const closeModal = () => {
    getModalStatus.value = false;
};
//SUBMIT FORM
            ...
            >
                ...
                <div class="flex flex-row justify-center">
                    ...
                    <div class="basis-1/2 mx-4">
                        ...
                        <div>
                            <label class="font-semibold text-lg">Modelo</label>
                            <input
                                v-model="item_model"
                                type="text"
                                class="w-100 rounded-2xl my-2 border-2 border-blue-500 text-center"
